...
import net.waret.bob.domain.Author;
import net.waret.bob.repository.AuthorRepository;
...
import static net.waret.bob.web.rest.TestUtil.createFormattingConversionService;
