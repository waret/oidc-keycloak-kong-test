package net.waret.bob.repository;

import net.waret.bob.BobApp;
import net.waret.bob.config.Constants;
import net.waret.bob.config.audit.AuditEventConverter;
import net.waret.bob.domain.PersistentAuditEvent;
...
import static net.waret.bob.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
