package net.waret.bob.service;

import net.waret.bob.config.Constants;
import net.waret.bob.domain.Authority;
import net.waret.bob.domain.User;
import net.waret.bob.repository.AuthorityRepository;
import net.waret.bob.repository.UserRepository;
import net.waret.bob.security.SecurityUtils;
