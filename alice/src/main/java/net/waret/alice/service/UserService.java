package net.waret.alice.service;

import net.waret.alice.config.Constants;
import net.waret.alice.domain.Authority;
import net.waret.alice.domain.User;
import net.waret.alice.repository.AuthorityRepository;
import net.waret.alice.repository.UserRepository;
import net.waret.alice.security.SecurityUtils;
    ...
    public void updateUser(String firstName, String lastName, String email, String langKey, String imageUrl) {
        SecurityUtils.getCurrentUserLogin()
            ...
            .ifPresent(user -> {
                ...
                user.setEmail(email == null ? email : email.toLowerCase());
