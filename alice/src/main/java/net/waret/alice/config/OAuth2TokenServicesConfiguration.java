package net.waret.alice.config;
...
import net.waret.alice.security.oauth2.SimpleAuthoritiesExtractor;
import net.waret.alice.security.oauth2.SimplePrincipalExtractor;
