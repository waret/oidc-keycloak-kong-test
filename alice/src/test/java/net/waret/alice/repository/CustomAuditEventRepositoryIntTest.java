package net.waret.alice.repository;

import net.waret.alice.AliceApp;
import net.waret.alice.config.Constants;
import net.waret.alice.config.audit.AuditEventConverter;
import net.waret.alice.domain.PersistentAuditEvent;
...
import static net.waret.alice.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
